...
STATUS_REJECTED = "rejected"  # Synonym or explicit UI mapping
    ...
    def log_decision(
        ...
        self._conn.execute(
            ...
            INSERT INTO decision_journal
                (id, timestamp, contact_id, message_id, action_type, decision,
                 rules_triggered, reason, result, execution_status)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
            """,
            (
                uuid.uuid4().hex[:12],
