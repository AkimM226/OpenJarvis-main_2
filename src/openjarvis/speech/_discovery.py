...
def get_tts_backend(config: "JarvisConfig") -> Optional["SpeechBackend"]:
    """Resolve the TTS backend."""
    import openjarvis.speech  # noqa: F401
    from openjarvis.core.registry import TTSRegistry

    if TTSRegistry.contains("kokoro"):
        try:
            return TTSRegistry.get("kokoro")()
        except Exception:
            pass

    if TTSRegistry.contains("cartesia"):
        try:
            return TTSRegistry.get("cartesia")()
        except Exception:
            pass
