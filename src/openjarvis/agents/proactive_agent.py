...
Each action object must have these fields:
  - action_type: one of email_delete | email_archive | sms_send | sms_draft_reply |
                 ...
                 email_reply_arduino_pricing | email_reply_ai_training_pricing |
                 email_reply_generic_inquiry | email_reply_institutional
...
class ProactiveAgent(ToolUsingAgent):
    ...
    def run(
        ...
        **kwargs: Any,
        ...
        from openjarvis.security.commercial_rules import apply_commercial_rules
        ...
        for item in proposed:
            ...
            # Deterministic override for commercial rules (Addendum 7)
            tier = apply_commercial_rules(action_type, payload, tier)
