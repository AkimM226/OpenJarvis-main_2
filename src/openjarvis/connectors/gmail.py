...
class GmailConnector(BaseConnector):
    ...
    def send_message(self, to: str, subject: str, body: str) -> Dict[str, Any]:
        ...
        -------
        dict
            Gmail API response containing the sent message ID.
        """
        return self._call_with_refresh(
            _gmail_api_send_message,
            to=to,
            subject=subject,
            body=body,
        )

    def reply_to_thread(self, to: str, subject: str, body: str, thread_id: str, in_reply_to: Optional[str] = None) -> Dict[str, Any]:
        """Reply to an existing email thread via Gmail API.
        ...
        to:
            Recipient email address.
        subject:
            Email subject line (typically RE: ...).
        body:
            Email body text.
        thread_id:
